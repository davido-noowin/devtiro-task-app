...
public record CreateTaskRequestDto(
        ...
        String description,
            ...
            @Nullable
        LocalDate dueDate,
            @NotNull(message = ERROR_MESSAGE_PRIO)
        TaskPriority priority
) {
    private static final String ERROR_MESSAGE_TITLE_LENGTH = "Title must be between 1 and 255 characters.";
    private static final String ERROR_MESSAGE_DESCRIPTION_LENGTH = "Description must be less than 100 characters";
    private static final String ERROR_MESSAGE_DUE_DATE_FUTURE = "Due date must be in the future";
    private static final String ERROR_MESSAGE_PRIO = "Task priority must be provided";
}
